...
(
    ...
    'ระบบบันทึกประวัติและสอบเทียบเครื่องมือวัดของไซต์งานก่อสร้างทั้ง 17 แห่ง ใช้ตรวจสอบค่าใช้จ่าย ส่งออกเอกสาร PDF และทำเรื่องขอโอนย้ายอุปกรณ์ข้ามไซต์งานโดยมี Super Admin เป็นผู้อนุมัติ',
...
(
    ...
    'ระบบติดตามแผนงานและงบประมาณไอทีรายปี (Capex & Opex) ในรูปแบบ Gantt Chart พร้อมใช้เป็นระบบวัดผลงาน (KPI) ของเจ้าหน้าที่ไอทีในทีม',
...
(
    'IN-HOUSE HELP DESK',
    'ระบบแจ้งซ่อมคอมพิวเตอร์และช่วยเหลือปัญหาไอทีของพนักงาน 160 คน พร้อมระบบส่งแจ้งเตือนผ่าน LINE และอีเมลอัตโนมัติ',
...
(
    ...
    'ระบบวิเคราะห์และสรุปยอดค่าใช้จ่ายการพิมพ์เอกสารแยกตามแผนก ช่วยควบคุมและลดค่าใช้จ่ายไอที (Opex) ขององค์กร',
...
(
    'LICENSE TRACKER',
    'ระบบบริหารและจัดสรรสิทธิ์โปรแกรมลิขสิทธิ์ของบริษัท (เช่น M365, AutoCAD, ZwCAD) ช่วยประหยัดค่าใช้จ่ายได้กว่า 1.12 ล้านบาทต่อปี',
...
(
    'MEC PROJECT COST DASHBOARD',
    'แดชบอร์ดสรุปค่าใช้จ่ายโครงการก่อสร้างทั้ง 17 ไซต์งานแบบ Real-time เพื่อให้ผู้บริหารตรวจสอบสถานะการเงินและควบคุมงบประมาณของแต่ละโครงการได้ทันที',
    ARRAY['Next.js', 'Supabase', 'SQL', 'Python', 'Vercel']::TEXT[],
    '#',
    false,
    6
);
...
('IT Infrastructure (หลัก)', 'Switch L3,L2 Cisco / Aruba / HP', 'Advanced', 2),
